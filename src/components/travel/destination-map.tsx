    ...
    (async () => {
      ...
      destinations.forEach((d) => {
        const marker = L.marker([d.lat, d.lng], {
          ...
          icon: L.divIcon({
            className: "",
            html: `<span style="display:flex;height:34px;width:34px;align-items:center;justify-content:center;border-radius:9999px;background:var(--primary);color:var(--primary-foreground);box-shadow:0 8px 20px -6px rgba(0,0,0,.45);font-size:15px">📍</span>`,
            iconSize: [34, 34],
            iconAnchor: [17, 34],
            popupAnchor: [0, -30],
          }),
        ...
        marker.bindPopup(
          `<div style="width:220px;font-family:inherit">
            ...
            <a href="/destinations/${d.slug}" style="display:inline-block;margin-top:10px;padding:7px 12px;border-radius:9999px;background:var(--primary);color:var(--primary-foreground);font-size:12px;font-weight:600;text-decoration:none">View destination</a>
          </div>`,
        );
