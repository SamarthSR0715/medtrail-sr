...
import routeSinhagadAsset from "@/assets/routes/route-0283.jpg";
import routeKanheKhandiAsset from "@/assets/routes/route-0297.jpg";
...
export const destinations: Destination[] = [
  ...
  },
  {
    slug: "sinhagad-fort",
    name: "Sinhagad Fort",
    tagline: "The lion's fort — history on Pune's doorstep",
    district: "Pune",
    state: "Maharashtra",
    categories: ["Forts", "Trekking", "Temples"],
    hero: realPhotos.sinhagadRelief,
    routeMap: realPhotos.routeSinhagad,
    lat: 18.3664,
    lng: 73.7556,
    distanceKm: 30,
    travelTime: "1.5 – 2 hrs",
    ...
    rating: 4.5,
    season: "June to February",
    weather: "Cool and windy through the monsoon; clear valley views in winter.",
    sunrise: "6:20 AM",
    sunset: "6:55 PM",
    visitedOn: "2026-01-18",
    summary:
      "The closest big fort to Pune — a 2.5 km historic trail up to Tanaji Malusare's memorial, Kalavantin bastion views and hot pithla bhakri at the top.",
    story:
      "Sinhagad is the fort every Punekar climbs first. Metro to Swargate, a PMPML bus to Donje Phata, and then the old stone trail that Tanaji's men climbed in 1670. The top is part memorial, part market — bronze reliefs of Shivaji Maharaj's durbar, golden warrior statues mid-charge, and stalls selling curd, kanda bhaji and lemon soda while the wind comes straight up the valley.",
    highlights: [
      "Bronze durbar relief of Chhatrapati Shivaji Maharaj",
      "Tanaji Malusare memorial and Kalyan Darwaza",
      "Golden Maratha warrior statues in the memorial garden",
      "Pithla bhakri, curd and kanda bhaji at the summit stalls",
    ],
    carry: ["2L water", "Trekking shoes", "Cap and sunscreen", "Windcheater", "Cash for stalls"],
    nearby: ["Khadakwasla Dam", "Panshet", "Donje waterfalls", "Rajgad Fort"],
    photoSpots: ["Bronze relief wall", "Warrior statue garden", "Kalyan Darwaza", "Valley edge viewpoint"],
    tips: [
      "Take the metro to Swargate — parking at the base fills up fast on weekends",
      "Start before 8am; the trail has almost no shade",
      "Carry cash, most summit stalls do not accept UPI",
    ],
    safety: [
      "The rock trail is slippery in heavy rain",
      "Stay behind the railings at the valley edge",
      "Descend before dusk — the trail is unlit",
    ],
    expenses: [
      { label: "Metro to Swargate", amount: "₹20 – 30" },
      { label: "PMPML bus to Donje Phata", amount: "₹40 – 60" },
      { label: "Food at the top", amount: "₹150 – 250" },
      { label: "Total per person", amount: "₹250 – 400" },
    ],
    timeline: [
      { mode: "start", title: "Pune Station", detail: "Start your journey", time: "0:00" },
      { mode: "metro", title: "Swargate", detail: "Pune Metro to Swargate", time: "20 min" },
      { mode: "bus", title: "Donje Phata", detail: "PMPML bus towards Sinhagad base", time: "45 – 60 min" },
      { mode: "trek", title: "Historic stone trail", detail: "2.5 km climb on the old fort path", time: "1 – 1.5 hrs" },
      { mode: "end", title: "Sinhagad Fort", detail: "Memorials, darwazas and summit stalls", time: "1.5 hrs explore" },
    ],
    info: {
      entryFee: "Free",
      parking: "Base and top road, ₹30 – 50",
      food: "Many stalls at the top",
      water: "Carry 2 litres; refills available at top",
      washrooms: "At the summit",
      network: "Good",
      camping: "Not allowed",
      guide: "Not required",
    },
    gallery: [realPhotos.sinhagadRelief, realPhotos.sinhagadWarriors],
    googleMapsUrl: "https://www.google.com/maps/dir/Pune/Sinhagad+Fort",
  },
  {
    slug: "hidden-waterfall-kanhe-khandi",
    name: "Hidden Waterfall (Kanhe – Khandi)",
    tagline: "A monsoon drive to a two-tier fall almost nobody visits",
    district: "Pune",
    state: "Maharashtra",
    categories: ["Waterfalls", "Nature"],
    hero: realPhotos.hiddenWaterfall,
    routeMap: realPhotos.routeKanheKhandi,
    lat: 18.6889,
    lng: 73.5361,
    distanceKm: 72,
    travelTime: "2 – 2.5 hrs",
    trekTime: "20 – 30 min from the road",
    trekDistanceKm: 1,
    elevationM: 620,
    difficulty: "Easy",
    rating: 4.6,
    season: "July to September",
    weather: "Full monsoon country — constant drizzle, low cloud and flooded paddy terraces.",
    sunrise: "6:12 AM",
    sunset: "7:10 PM",
    visitedOn: "2025-07-20",
    summary:
      "A quiet two-tier waterfall on the Kanhe to Khandi monsoon route — 70–75 km from Pune via NH48, with roadside falls the whole way.",
    story:
      "This one is a drive, not a trek. Out of Pune on NH48, exit at Kanhe and take the village road towards Khandi past Vadeshwar, Muli, Jugjur, Lahivadi and Bardenwad. Somewhere along that stretch the road bends and a two-tier fall drops straight into flooded paddy terraces that mirror it. We parked, walked down, and made maggi on the trail with the fall in the frame.",
    highlights: [
      "Two-tier waterfall dropping into mirrored paddy terraces",
      "A string of roadside falls between Kanhe and Khandi",
      "Khandi Point viewpoint at the end of the route",
      "Trail maggi with the fall behind you",
    ],
    carry: ["Raincoat", "Grippy shoes", "Dry bag for phone", "Portable stove / snacks", "Trash bag"],
    nearby: ["Kanhe Phata", "Bardenwad Waterfall", "Tikona Fort", "Pawna Lake"],
    photoSpots: ["Lower tier from the paddy edge", "Road bend overlook", "Khandi Point"],
    tips: [
      "Go on a weekday morning — the road is single lane in places",
      "Two-wheelers are far easier than cars on the village stretch",
      "Carry everything out; there are no bins anywhere",
    ],
    safety: [
      "Never stand under or above the fall — rock is loose in monsoon",
      "Water level rises fast after upstream rain",
      "Village roads flood; do not cross moving water",
    ],
    expenses: [
      { label: "Fuel (two-wheeler, round trip)", amount: "₹250 – 350" },
      { label: "Tolls (if by car)", amount: "₹90 – 150" },
      { label: "Food / maggi stops", amount: "₹150 – 250" },
      { label: "Total per person", amount: "₹400 – 600" },
    ],
    timeline: [
      { mode: "start", title: "Pune", detail: "Start your journey", time: "0:00" },
      { mode: "jeep", title: "NH48 to Kanhe", detail: "Highway ride, 45 – 50 km", time: "1 – 1.25 hrs" },
      { mode: "view", title: "Vadeshwar → Muli → Jugjur", detail: "Village road with roadside falls", time: "40 min" },
      { mode: "walk", title: "Descent to the fall", detail: "Short walk down the paddy edge", time: "20 – 30 min" },
      { mode: "end", title: "Khandi Point", detail: "Two-tier fall and valley viewpoint", time: "1 – 2 hrs" },
    ],
    info: {
      entryFee: "Free",
      parking: "Roadside only, no fee",
      food: "Nothing on route — carry your own",
      water: "Carry 2 litres",
      washrooms: "None",
      network: "Patchy after Kanhe",
      camping: "Not advisable in monsoon",
      guide: "Not required",
    },
    gallery: [realPhotos.hiddenWaterfall, realPhotos.hiddenWaterfallMaggi],
    googleMapsUrl: "https://www.google.com/maps/dir/Pune/Khandi+Point",
  },
];
