...
export const searchIndex: SearchEntry[] = [
  ...
  { to: "/destinations/sinhagad", title: "Sinhagad Fort", group: "Destinations", keywords: "pune metro bus pithla bhakri trek" },
  { to: "/destinations/pawna-lake", title: "Pawna Lake & Amour Café", group: "Destinations", keywords: "camping lakeside sunset cafe" },
  { to: "/destinations/tikona", title: "Tikona Fort", group: "Destinations", keywords: "triangular fort pawna quick trek" },
  { to: "/bucket-list", title: "Travel bucket list", group: "Travel Journal", keywords: "wishlist kalsubai harishchandragad plans" },
