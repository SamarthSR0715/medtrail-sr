...
export const searchIndex: SearchEntry[] = [
  ...
  { to: "/bucket-list", title: "Travel wishlist & bucket list", group: "Travel Journal", keywords: "wishlist coming soon kalsubai harishchandragad sinhagad mahabaleshwar plans" },
